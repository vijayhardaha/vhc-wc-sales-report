...
! ( function( n ) {
	...
	var e, n, s, p, r, o, h, f, g, m, y, v, i, a, _,
		s = ( ( u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u ) && u.requirejs || ( u ? n = u : u = {}, g = {}, m = {}, y = {}, v = {}, i = Object.prototype.hasOwnProperty, a = [].slice, _ = /\.js$/, h = function( e, t ) {
			...
			const t = g[ e ]; return void 0 !== t ? t : g[ e ] = {};
		}, module( e ) {
			...
			const e = t || $; return null == e && console && console.error && console.error( 'Select2: An instance of jQuery or a jQuery-compatible library was not found. Make sure that you are including jQuery before Select2 on your web page.' ), e;
			...
			const s = {}; function c( e ) {
				...
				const e = c( i ),
					...
					const o = t[ n ]; r.prototype[ o ] = s.prototype[ o ];
				} for ( let a = 0; a < e.length; a++ ) {
					const l = e[ a ]; r.prototype[ l ] = ( function( e ) {
						let t = function() {}; e in r.prototype && ( t = r.prototype[ e ] ); const n = i.prototype[ e ]; return function() {
				...
				for ( const t in e ) {
					let n = t.split( '-' ),
						...
						for ( let i = 0; i < n.length; i++ ) {
							let r = n[ i ]; ( r = r.substring( 0, 1 ).toLowerCase() + r.substring( 1 ) ) in s || ( s[ r ] = {} ), i == n.length - 1 && ( s[ r ] = e[ t ] ), s = s[ r ];
						} delete e[ t ];
					}
				} return e;
				...
				const t = { '\\': '&#92;', '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', '\'': '&#39;', '/': '&#47;' }; return 'string' !== typeof e ? e : String( e ).replace( /[&<>"'\/\\]/g, function( e ) {
					return t[ e ];
				} );
			}, s.__cache = {}; let n = 0; return s.GetUniqueElementId = function( e ) {
				let t = e.getAttribute( 'data-select2-id' ); return null != t || ( t = e.id ? 'select2-data-' + e.id : 'select2-data-' + ( ++n ).toString() + '-' + s.generateChars( 4 ), e.setAttribute( 'data-select2-id', t ) ), t;
			}, s.StoreData = function( e, t, n ) {
				e = s.GetUniqueElementId( e ); s.__cache[ e ] || ( s.__cache[ e ] = {} ), s.__cache[ e ][ t ] = n;
			}, s.GetData = function( e, t ) {
				const n = s.GetUniqueElementId( e ); return t ? s.__cache[ n ] && null != s.__cache[ n ][ t ] ? s.__cache[ n ][ t ] : r( e ).data( t ) : s.__cache[ n ];
			}, s.RemoveData = function( e ) {
				const t = s.GetUniqueElementId( e ); null != s.__cache[ t ] && delete s.__cache[ t ], e.removeAttribute( 'data-select2-id' );
			...
			function s( e, t, n ) {
				...
				const e = d( '<ul class="select2-results__options" role="listbox"></ul>' ); return this.options.get( 'multiple' ) && e.attr( 'aria-multiselectable', 'true' ), this.$results = e;
			}, s.prototype.clear = function() {
				this.$results.empty();
			}, s.prototype.displayMessage = function( e ) {
				const t = this.options.get( 'escapeMarkup' ); this.clear(), this.hideLoading(); const n = d( '<li role="alert" aria-live="assertive" class="select2-results__option"></li>' ),
				...
				this.hideLoading(); const t = []; if ( null != e.results && 0 !== e.results.length ) {
				...
				const t = this; this.data.current( function( e ) {
				...
				const t = document.createElement( 'li' ); t.classList.add( 'select2-results__option' ), t.classList.add( 'select2-results__option--selectable' ); let n,
					...
					const r = s[ n ]; t.setAttribute( n, r );
				} if ( e.children ) {
					const o = d( t ),
				...
				const i = this,
					...
					const e = i.getHighlightedResults(); 0 !== e.length && e.trigger( 'mouseup' );
					...
					const t = p.GetData( this, 'data' ); i.getHighlightedResults().removeClass( 'select2-results__option--highlighted' ).attr( 'aria-selected', 'false' ), i.trigger( 'results:focus', { data: t, element: d( this ) } );
				} );
			...
			function r( e, t ) {
				...
				const e = n( '<span class="select2-selection" role="combobox"  aria-haspopup="true" aria-expanded="false"></span>' ); return this._tabindex = 0, null != s.GetData( this.$element[ 0 ], 'old-tabindex' ) ? this._tabindex = s.GetData( this.$element[ 0 ], 'old-tabindex' ) : null != this.$element.attr( 'tabindex' ) && ( this._tabindex = this.$element.attr( 'tabindex' ) ), e.attr( 'title', this.$element.attr( 'title' ) ), e.attr( 'tabindex', this._tabindex ), e.attr( 'aria-disabled', 'false' ), this.$selection = e;
				...
				const t = this; window.setTimeout( function() {
					document.activeElement == t.$selection[ 0 ] || n.contains( t.$selection[ 0 ], document.activeElement ) || t.trigger( 'blur', e );
				}, 1 );
			}, r.prototype._attachCloseHandler = function( e ) {
				n( document.body ).on( 'mousedown.select2.' + e.id, function( e ) {
					const t = n( e.target ).closest( '.select2' ); n( '.select2.select2-container--open' ).each( function() {
			...
			function i() {
				...
				const e = i.__super__.render.call( this ); return e[ 0 ].classList.add( 'select2-selection--single' ), e.html( '<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>' ), e;
			}, i.prototype.bind = function( t, e ) {
				const n = this; i.__super__.bind.apply( this, arguments ); const s = t.id + '-container'; this.$selection.find( '.select2-selection__rendered' ).attr( 'id', s ).attr( 'role', 'textbox' ).attr( 'aria-readonly', 'true' ), this.$selection.attr( 'aria-labelledby', s ), this.$selection.attr( 'aria-controls', s ), this.$selection.on( 'mousedown', function( e ) {
					1 === e.which && n.trigger( 'toggle', { originalEvent: e } );
				} ), this.$selection.on( 'focus', function( e ) {} ), this.$selection.on( 'blur', function( e ) {} ), t.on( 'focus', function( e ) {
					t.isOpen() || n.$selection.trigger( 'focus' );
				} );
			}, i.prototype.clear = function() {
				const e = this.$selection.find( '.select2-selection__rendered' ); e.empty(), e.removeAttr( 'title' );
			}, i.prototype.display = function( e, t ) {
				const n = this.options.get( 'templateSelection' ); return this.options.get( 'escapeMarkup' )( n( e, t ) );
			}, i.prototype.selectionContainer = function() {
				return e( '<span></span>' );
			}, i.prototype.update = function( e ) {
				let t, n; 0 !== e.length ? ( n = e[ 0 ], t = this.$selection.find( '.select2-selection__rendered' ), e = this.display( n, t ), t.empty().append( e ), ( n = n.title || n.text ) ? t.attr( 'title', n ) : t.removeAttr( 'title' ) ) : this.clear();
			}, i;
		} ), u.define( 'select2/selection/multiple', [ 'jquery', './base', '../utils' ], function( i, e, c ) {
			function r( e, t ) {
				r.__super__.constructor.apply( this, arguments );
			} return c.Extend( r, e ), r.prototype.render = function() {
				const e = r.__super__.render.call( this ); return e[ 0 ].classList.add( 'select2-selection--multiple' ), e.html( '<ul class="select2-selection__rendered"></ul>' ), e;
			}, r.prototype.bind = function( e, t ) {
				const n = this; r.__super__.bind.apply( this, arguments ); const s = e.id + '-container'; this.$selection.find( '.select2-selection__rendered' ).attr( 'id', s ), this.$selection.on( 'click', function( e ) {
					n.trigger( 'toggle', { originalEvent: e } );
				} ), this.$selection.on( 'click', '.select2-selection__choice__remove', function( e ) {
					let t; n.isDisabled() || ( t = i( this ).parent(), t = c.GetData( t[ 0 ], 'data' ), n.trigger( 'unselect', { originalEvent: e, data: t } ) );
			...
			function e( e, t, n ) {
				...
				const n = this.selectionContainer(); n.html( this.display( t ) ), n[ 0 ].classList.add( 'select2-selection__placeholder' ), n[ 0 ].classList.remove( 'select2-selection__choice' ); t = t.title || t.text || n.text(); return this.$selection.find( '.select2-selection__rendered' ).attr( 'title', t ), n;
			}, e.prototype.update = function( e, t ) {
				const n = 1 == t.length && t[ 0 ].id != this.placeholder.id; if ( 1 < t.length || n ) {
			...
			function e() {} return e.prototype.bind = function( e, t, n ) {
				const s = this; e.call( this, t, n ), null == this.placeholder && this.options.get( 'debug' ) && window.console && console.error && console.error( 'Select2: The `allowClear` option should be used in combination with the `placeholder` option.' ), this.$selection.on( 'mousedown', '.select2-selection__clear', function( e ) {
					s._handleClear( e );
				...
				if ( ! this.isDisabled() ) {
					const n = this.$selection.find( '.select2-selection__clear' ); if ( 0 !== n.length ) {
						t.stopPropagation(); const s = a.GetData( n[ 0 ], 'data' ),
							i = this.$element.val(); this.$element.val( this.placeholder.id ); let r = { data: s }; if ( this.trigger( 'clear', r ), r.prevented ) {
							this.$element.val( i );
						} else {
			...
			function e( e, t, n ) {
				...
				const s = this,
					...
					let t; e.stopPropagation(), s.trigger( 'keypress', e ), s._keyUpPrevented = e.isDefaultPrevented(), e.which !== l.BACKSPACE || '' !== s.$search.val() || 0 < ( t = s.$selection.find( '.select2-selection__choice' ).last() ).length && ( t = a.GetData( t[ 0 ], 'data' ), s.searchRemoveChoice( t ), e.preventDefault() );
					...
					let t; o && 'input' === e.type ? s.$selection.off( 'input.search input.searchcheck' ) : ( t = e.which ) != l.SHIFT && t != l.CTRL && t != l.ALT && t != l.TAB && s.handleSearch( e );
				} );
				...
				const n = this.$search[ 0 ] == document.activeElement; this.$search.attr( 'placeholder', '' ), e.call( this, t ), this.resizeSearch(), n && this.$search.trigger( 'focus' );
			}, e.prototype.handleSearch = function() {
				let e; this.resizeSearch(), this._keyUpPrevented || ( e = this.$search.val(), this.trigger( 'query', { term: e } ) ), this._keyUpPrevented = ! 1;
			}, e.prototype.searchRemoveChoice = function( e, t ) {
				this.trigger( 'unselect', { data: t } ), this.$search.val( t.text ), this.handleSearch();
			}, e.prototype.resizeSearch = function() {
				this.$search.css( 'width', '25px' ); let e = '100%'; '' === this.$search.attr( 'placeholder' ) && ( e = .75 * ( this.$search.val().length + 1 ) + 'em' ), this.$search.css( 'width', e );
			}, e;
			...
			function e() {} return e.prototype.bind = function( e, t, n ) {
				const s = this,
					...
					let n; -1 !== i.indexOf( e ) && ( t = t || {}, n = o.Event( 'select2:' + e, { params: t } ), s.$element.trigger( n ), -1 !== r.indexOf( e ) && ( t.prevented = n.isDefaultPrevented() ) );
				} );
			}, e;
			...
			function s( e ) {
				...
				let t; return e in s._cache || ( t = n( e ), s._cache[ e ] = t ), new s( s._cache[ e ] );
			}, s;
			...
			function n( e, t ) {
				...
				const t = this; e( Array.prototype.map.call( this.$element[ 0 ].querySelectorAll( ':checked' ), function( e ) {
					return t.item( l( e ) );
				} ) );
			}, n.prototype.select = function( i ) {
				let e,
					r = this; if ( i.selected = ! 0, null != i.element && 'option' === i.element.tagName.toLowerCase() ) {
					return i.element.selected = ! 0, void this.$element.trigger( 'input' ).trigger( 'change' );
				} this.$element.prop( 'multiple' ) ? this.current( function( e ) {
					const t = []; ( i = [ i ] ).push.apply( i, e ); for ( let n = 0; n < i.length; n++ ) {
						const s = i[ n ].id; -1 === t.indexOf( s ) && t.push( s );
					}r.$element.val( t ), r.$element.trigger( 'input' ).trigger( 'change' );
				} ) : ( e = i.id, this.$element.val( e ), this.$element.trigger( 'input' ).trigger( 'change' ) );
			}, n.prototype.unselect = function( i ) {
				const r = this; if ( this.$element.prop( 'multiple' ) ) {
					if ( i.selected = ! 1, null != i.element && 'option' === i.element.tagName.toLowerCase() ) {
						...
						for ( var t = [], n = 0; n < e.length; n++ ) {
							const s = e[ n ].id; s !== i.id && -1 === t.indexOf( s ) && t.push( s );
						}r.$element.val( t ), r.$element.trigger( 'input' ).trigger( 'change' );
					} );
				}
			}, n.prototype.bind = function( e, t ) {
				const n = this; ( this.container = e ).on( 'select', function( e ) {
					n.select( e.data );
				...
				const n = [],
					...
					let e; 'option' !== this.tagName.toLowerCase() && 'optgroup' !== this.tagName.toLowerCase() || ( e = l( this ), e = s.item( e ), null !== ( e = s.matches( t, e ) ) && n.push( e ) );
				} ), e( { results: n } );
			}, n.prototype.addOptions = function( e ) {
				this.$element.append( e );
			}, n.prototype.option = function( e ) {
				let t; e.children ? ( t = document.createElement( 'optgroup' ) ).label = e.text : void 0 !== ( t = document.createElement( 'option' ) ).textContent ? t.textContent = e.text : t.innerText = e.text, void 0 !== e.id && ( t.value = e.id ), e.disabled && ( t.disabled = ! 0 ), e.selected && ( t.selected = ! 0 ), e.title && ( t.title = e.title ); e = this._normalizeItem( e ); return e.element = t, a.StoreData( t, 'data', e ), l( t );
			}, n.prototype.item = function( e ) {
				let t = {}; if ( null != ( t = a.GetData( e[ 0 ], 'data' ) ) ) {
					return t;
				} const n = e[ 0 ]; if ( 'option' === n.tagName.toLowerCase() ) {
			...
			function n( e, t ) {
				...
				const s = this; null != this._request && ( 'function' === typeof this._request.abort && this._request.abort(), this._request = null ); const i = r.extend( { type: 'GET' }, this.ajaxOptions ); function e() {
			...
			function e( e, t, n ) {
				...
				const d = this; this._removeOldTags(), null != c.term && null == c.page ? e.call( this, c, function e( t, n ) {
					for ( var s = t.results, i = 0; i < s.length; i++ ) {
						const r = s[ i ],
							o = null != r.children && ! e( { results: r.children }, ! 0 ); if ( ( r.text || '' ).toUpperCase() === ( c.term || '' ).toUpperCase() || o ) {
				...
				if ( null == t.term ) {
					return null;
				} t = t.term.trim(); return '' === t ? null : { id: t, text: t };
			...
			function e( e, t, n ) {
				const s = n.get( 'tokenizer' ); void 0 !== s && ( this.tokenizer = s ), e.call( this, t, n );
			} return e.prototype.bind = function( e, t, n ) {
				e.call( this, t, n ), this.$search = t.dropdown.$search || t.selection.$search || n.find( '.select2-search__field' );
			}, e.prototype.query = function( e, t, n ) {
				const s = this; t.term = t.term || ''; const i = this.tokenizer( t, this.options, function( e ) {
					let t,
				...
				for ( var i = n.get( 'tokenSeparators' ) || [], r = t.term, o = 0, a = this.createTag || function( e ) {
					...
					let l = r[ o ]; -1 !== i.indexOf( l ) ? ( l = r.substr( 0, o ), null != ( l = a( c.extend( {}, t, { term: l } ) ) ) ? ( s( l ), r = r.substr( o + 1 ) || '', o = 0 ) : o++ ) : o++;
				} return { term: r };
			}, e;
			...
			function e( e, t, n ) {
				...
				const s = this; e.call( this, t, n ), t.on( 'select', function() {
					s._checkIfMaximumSelected();
				} );
			}, e.prototype.query = function( e, t, n ) {
				const s = this; this._checkIfMaximumSelected( function() {
					e.call( s, t, n );
				} );
			}, e.prototype._checkIfMaximumSelected = function( e, t ) {
				const n = this; this.current( function( e ) {
			...
			function n( e, t ) {
				...
				const e = t( '<span class="select2-dropdown"><span class="select2-results"></span></span>' ); return e.attr( 'dir', this.options.get( 'dir' ) ), this.$dropdown = e;
			...
			function e() {} return e.prototype.render = function( e ) {
				...
				let t; this._keyUpPrevented || ( t = this.$search.val(), this.trigger( 'query', { term: t } ) ), this._keyUpPrevented = ! 1;
			...
			function e( e, t, n, s ) {
				...
				for ( var n = t.slice( 0 ), s = t.length - 1; 0 <= s; s-- ) {
					const i = t[ s ]; this.placeholder.id === i.id && n.splice( s, 1 );
				} return n;
			}, e;
			...
			function e( e, t, n, s ) {
				...
				const s = this; e.call( this, t, n ), t.on( 'query', function( e ) {
					s.lastParams = e, s.loading = ! 0;
				} ), t.on( 'query:append', function( e ) {
					s.lastParams = e, s.loading = ! 0;
				} ), this.$results.on( 'scroll', this.loadMoreIfNeeded.bind( this ) );
			}, e.prototype.loadMoreIfNeeded = function() {
				let e = n.contains( document.documentElement, this.$loadingMore[ 0 ] ); ! this.loading && e && ( e = this.$results.offset().top + this.$results.outerHeight( ! 1 ), this.$loadingMore.offset().top + this.$loadingMore.outerHeight( ! 1 ) <= e + 50 && this.loadMore() );
			}, e.prototype.loadMore = function() {
				this.loading = ! 0; const e = n.extend( {}, { page: 1 }, this.lastParams ); e.page++, this.trigger( 'query:append', e );
			}, e.prototype.showLoadingMore = function( e, t ) {
				return t.pagination && t.pagination.more;
			}, e.prototype.createLoadingMore = function() {
				const e = n( '<li class="select2-results__option select2-results__option--load-more"role="option" aria-disabled="true"></li>' ),
			...
			function e( e, t, n ) {
				...
				const s = this; e.call( this, t, n ), t.on( 'open', function() {
				...
				let n; this._containerResultsHandlersBound || ( n = this, t.on( 'results:all', function() {
				...
				var n = this,
					...
					const t = o.GetData( this, 'select2-scroll-position' ); u( this ).scrollTop( t.y );
				...
				const e = { width: this.$container.outerWidth( ! 1 ) + 'px' }; this.options.get( 'dropdownAutoWidth' ) && ( e.minWidth = e.width, e.position = 'relative', e.width = 'auto' ), this.$dropdown.css( e );
			...
			function e( e, t, n, s ) {
				...
				return ! ( ( function e( t ) {
					for ( var n = 0, s = 0; s < t.length; s++ ) {
						const i = t[ s ]; i.children ? n += e( i.children ) : n++;
					} return n;
				}( t.data.results ) ) < this.minimumResultsForSearch ) && e.call( this, t );
			}, e;
		} ), u.define( 'select2/dropdown/selectOnClose', [ '../utils' ], function( s ) {
			function e() {} return e.prototype.bind = function( e, t, n ) {
				const s = this; e.call( this, t, n ), t.on( 'close', function( e ) {
					s._handleSelectOnClose( e );
				} );
			}, e.prototype._handleSelectOnClose = function( e, t ) {
				if ( t && null != t.originalSelect2Event ) {
					var n = t.originalSelect2Event; if ( 'select' === n._type || 'unselect' === n._type ) {
						return;
					}
			...
			function e() {} return e.prototype.bind = function( e, t, n ) {
				const s = this; e.call( this, t, n ), t.on( 'select', function( e ) {
					s._selectTriggered( e );
				} ), t.on( 'unselect', function( e ) {
					s._selectTriggered( e );
				} );
			}, e.prototype._selectTriggered = function( e, t ) {
				const n = t.originalEvent; n && ( n.ctrlKey || n.metaKey ) || this.trigger( 'close', { originalEvent: n, originalSelect2Event: t } );
			}, e;
			...
			function e() {} return e.prototype.highlightFirstItem = function( e ) {
				var t = this.$results.find( '.select2-results__option--selectable:not(.select2-results__option--selected)' ); if ( 0 < t.length ) {
					var n = t.first(),
						t = s.GetData( n[ 0 ], 'data' ).element; if ( t && t.getAttribute && 'true' === t.getAttribute( 'data-select2-tag' ) ) {
			...
			return { errorLoading() {
				...
				let t = 'You can only select ' + e.maximum + ' item'; return 1 != e.maximum && ( t += 's' ), t;
			}, noResults() {
			...
			function n() {
				...
				}, minimumInputLength: 0, maximumInputLength: 0, maximumSelectionLength: 0, minimumResultsForSearch: 0, selectOnClose: ! 1, scrollAfterSelect: ! 1, sorter( e ) {
					return e;
				}, templateResult( e ) {
					return e.text;
				}, templateSelection( e ) {
				...
				let n = {}; n[ l.camelCase( e ) ] = t; n = f._convertData( n ); l.extend( ! 0, this.defaults, n );
			}, new n;
		} ), u.define( 'select2/options', [ 'jquery', './defaults', './utils' ], function( c, n, u ) {
			function e( e, t ) {
				this.options = e, null != t && this.fromElement( t ), null != t && ( this.options = n.applyFromElement( this.options, t ) ), this.options = n.apply( this.options );
			} return e.prototype.fromElement = function( e ) {
				const t = [ 'select2' ]; null == this.options.multiple && ( this.options.multiple = e.prop( 'multiple' ) ), null == this.options.disabled && ( this.options.disabled = e.prop( 'disabled' ) ), null == this.options.autocomplete && e.prop( 'autocomplete' ) && ( this.options.autocomplete = e.prop( 'autocomplete' ) ), null == this.options.dir && ( e.prop( 'dir' ) ? this.options.dir = e.prop( 'dir' ) : e.closest( '[dir]' ).prop( 'dir' ) ? this.options.dir = e.closest( '[dir]' ).prop( 'dir' ) : this.options.dir = 'ltr' ), e.prop( 'disabled', this.options.disabled ), e.prop( 'multiple', this.options.multiple ), u.GetData( e[ 0 ], 'select2Tags' ) && ( this.options.debug && window.console && console.warn && console.warn( 'Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.' ), u.StoreData( e[ 0 ], 'data', u.GetData( e[ 0 ], 'select2Tags' ) ), u.StoreData( e[ 0 ], 'tags', ! 0 ) ), u.GetData( e[ 0 ], 'ajaxUrl' ) && ( this.options.debug && window.console && console.warn && console.warn( 'Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2.' ), e.attr( 'ajax--url', u.GetData( e[ 0 ], 'ajaxUrl' ) ), u.StoreData( e[ 0 ], 'ajax-Url', u.GetData( e[ 0 ], 'ajaxUrl' ) ) ); let n = {}; function s( e, t ) {
				...
				}c.fn.jquery && '1.' == c.fn.jquery.substr( 0, 2 ) && e[ 0 ].dataset && ( n = c.extend( ! 0, {}, e[ 0 ].dataset, n ) ); let a,
			...
			var o = function( e, t ) {
				...
				e.insertAfter( this.$element ); const t = this._resolveWidth( this.$element, this.options.get( 'width' ) ); null != t && e.css( 'width', t );
			}, o.prototype._resolveWidth = function( e, t ) {
				const n = /^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i; if ( 'resolve' == t ) {
				...
				} e = e.attr( 'style' ); if ( 'string' !== typeof e ) {
					return null;
				} for ( let i = e.split( ';' ), r = 0, o = i.length; r < o; r += 1 ) {
					const a = i[ r ].replace( /\s/g, '' ).match( n ); if ( null !== a && 1 <= a.length ) {
						return a[ 1 ];
					}
				} return null;
				...
				const t = this; this.$element.on( 'change.select2', function() {
				...
				const n = this; this.dataAdapter.on( '*', function( e, t ) {
					n.trigger( e, t );
				} );
				...
				const n = this; this.dropdown.on( '*', function( e, t ) {
					n.trigger( e, t );
				} );
			}, o.prototype._registerResultsEvents = function() {
				const n = this; this.results.on( '*', function( e, t ) {
					n.trigger( e, t );
				} );
			}, o.prototype._registerEvents = function() {
				const n = this; this.on( 'open', function() {
					...
					const t = e.which; n.isOpen() ? t === s.ESC || t === s.UP && e.altKey ? ( n.close( e ), e.preventDefault() ) : t === s.ENTER || t === s.TAB ? ( n.trigger( 'results:select', {} ), e.preventDefault() ) : t === s.SPACE && e.ctrlKey ? ( n.trigger( 'results:toggle', {} ), e.preventDefault() ) : t === s.UP ? ( n.trigger( 'results:previous', {} ), e.preventDefault() ) : t === s.DOWN && ( n.trigger( 'results:next', {} ), e.preventDefault() ) : ( t === s.ENTER || t === s.SPACE || t === s.DOWN && e.altKey ) && ( n.open(), e.preventDefault() );
				} );
			}, o.prototype._syncAttributes = function() {
				this.options.set( 'disabled', this.$element.prop( 'disabled' ) ), this.isDisabled() ? ( this.isOpen() && this.close(), this.trigger( 'disable', {} ) ) : this.trigger( 'enable', {} );
			}, o.prototype._isChangeMutation = function( e ) {
				const t = this; if ( e.addedNodes && 0 < e.addedNodes.length ) {
				...
				var n = o.__super__.trigger,
					...
					var i = s[ e ],
						s = { prevented: ! 1, name: e, args: t }; if ( n.call( this, i, s ), s.prevented ) {
				...
				this.options.get( 'debug' ) && 0 < arguments.length && window.console && console.warn && console.warn( 'Select2: Data can no longer be set using `select2("data")`. You should consider setting the value instead using `$element.val()`.' ); let t = []; return this.dataAdapter.current( function( e ) {
					t = e;
				} ), t;
				...
				const e = t( '<span class="select2 select2-container"><span class="selection"></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>' ); return e.attr( 'dir', this.options.get( 'dir' ) ), this.$container = e, this.$container[ 0 ].classList.add( 'select2-container--' + this.options.get( 'theme' ) ), r.StoreData( e[ 0 ], 'element', this.$element ), e;
			}, o;
		} ), u.define( 'jquery-mousewheel', [ 'jquery' ], function( e ) {
			return e;
		} ), u.define( 'jquery.select2', [ 'jquery', 'jquery-mousewheel', './select2/core', './select2/defaults', './select2/utils' ], function( i, e, r, t, o ) {
			let a; return null == i.fn.select2 && ( a = [ 'open', 'close', 'destroy' ], i.fn.select2 = function( t ) {
				if ( 'object' === typeof ( t = t || {} ) ) {
					return this.each( function() {
						const e = i.extend( ! 0, {}, t ); new r( i( this ), e );
					} ), this;
				} if ( 'string' !== typeof t ) {
					throw new Error( 'Invalid arguments for Select2: ' + t );
				} let n,
					s = Array.prototype.slice.call( arguments, 1 ); return this.each( function() {
					const e = o.GetData( this, 'select2' ); null == e && window.console && console.error && console.error( 'The select2(\'' + t + '\') method was called on an element that is not using Select2.' ), n = e[ t ].apply( e, s );
		...
		return function() {
			const e = a.call( arguments, 0 ); return 'string' !== typeof e[ 0 ] && 1 === e.length && e.push( null ), o.apply( p, e.concat( [ t, n ] ) );
		};
	} function x( e ) {
		let t; if ( b( m, e ) && ( t = m[ e ], delete m[ e ], v[ e ] = ! 0, r.apply( p, t ) ), ! b( g, e ) && ! b( v, e ) ) {
